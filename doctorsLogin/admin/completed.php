...
<div class="container-fluid pt-4 px-4">
    ...
    <div class="row g-4 mb-4">
        <div class="col-sm-6 col-xl-3">
            <div class="bg-light rounded d-flex align-items-center p-4">
                ...
                <div class="ms-3">
                    <p class="mb-2">Total Completed<br>Appointments</p>
                    <h6 class="mb-0">
                        <?php
    ...
    <div class="bg-light rounded p-4">
        ...
        <div id="noDataMessage" class="text-center py-5" style="display: none;">
            ...
            <p class="text-muted small mb-0">Completed appointments will appear here.</p>
        </div>
    </div>
            ...
            <div class="modal-content border-0 rounded-0">
                ...
                <form action="" method="POST">
                                        ...
                                        <div class="col-md-6">
                                            <div class="p-3 bg-white rounded">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="badge bg-success text-white"><?= htmlspecialchars($appointment_details['status']) ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <button type="submit" name="viewDetails" class="btn btn-success rounded-0  btn-sm d-none">
...
<script>
    ...
    function viewDetails(appointmentId) {
        ...
        window.location.href = 'completed.php?edit=' + appointmentId;
    }
