...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            <a href="../doctor/dashboard.php" class="nav-item nav-link <?= in_array($current_page, ['dashboard.php']) ? 'active' : '' ?>"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle <?= in_array($current_page, ['upcoming.php', 'completed.php', 'reschedule.php']) ? 'active show' : '' ?>" data-bs-toggle="dropdown"><i class="fa-regular fa-calendar-check me-2"></i>Appointment</a>
                <div class="dropdown-menu bg-transparent border-0  <?= in_array($current_page, ['upcoming.php', 'completed.php', 'reschedule.php']) ? 'show' : '' ?>">
                    <a href="../doctor/upcoming.php" class="dropdown-item  <?= in_array($current_page, ['upcoming.php']) ? 'active' : '' ?>">
                        <i class="fa-solid fa-calendar-day me-2"></i> Upcoming
                    </a>
                    <a href="signup.html" class="dropdown-item <?= in_array($current_page, ['completed.php']) ? 'active' : '' ?>">
                        <i class="fa-solid fa-calendar-check me-2"></i> Completed
                    </a>
                    <a href="404.html" class="dropdown-item <?= in_array($current_page, ['reschedule.php']) ? 'active' : '' ?>">
