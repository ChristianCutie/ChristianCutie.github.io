<%@ Page Title="History | Medical Apointment System" Language="C#" MasterPageFile="~/ClientDashboard.master" AutoEventWireup="true" CodeFile="~/client/History.aspx.cs" Inherits="_Default" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                      <asp:GridView ID="myappointmentlist" DataKeyNames="PATIENT_ID" runat="server" CssClass="datatable table-hover table table-striped" AutoGenerateColumns="false">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="SPECIALTY" HeaderText="Type"></asp:BoundField>
